...
To use this plugin create a new content element and add the "Entity Facts listing"
...
It is possible to select additional links to other sources like wikipedia, that
is the last check mark.

The default CSS file "/Resources/Public/Css/SlubEntityfacts.css" will be
included by TypoScript when including the TypoScript template.
